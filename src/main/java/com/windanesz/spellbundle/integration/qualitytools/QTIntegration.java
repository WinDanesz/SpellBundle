...
public class QTIntegration extends Integration {

	// singleton instance
	private static final QTIntegration instance = new QTIntegration();
	private static final String modId = "qualitytools";
	...
	public boolean isEnabled() {
		return Settings.generalSettings.qualitytools_integration && isLoaded;
	}

...
public class CurseOfHaunting extends SpellRay {

	public CurseOfHaunting(){
		super(SpellBundle.MODID,"curse_of_haunting", SpellActions.POINT, false);
	...
	protected boolean onEntityHit(World world, Entity target, Vec3d hit, EntityLivingBase caster, Vec3d origin, int ticksInUse, SpellModifiers modifiers){
		...
		if(EntityUtils.isLiving(target)){
			...
			((EntityLivingBase)target).addPotionEffect(new PotionEffect(SBPotions.curse_of_haunting, Integer.MAX_VALUE,
